...
import CalacaLogo from "/images/churchlogo.svg"; // Replace with the actual path to Calaca Baptist Church Logo
import VOMLogo from "/images/vom-logo.png"; // Replace with the actual path to Voice of the Martyrs Logo
import CloudBackground from "/images/cloud-background.svg"; // Replace with the actual path to your cloud background SVG
import BackgroundImage from "/images/background-image.jpg"; // Replace with the actual path to your background image
      ...
      >
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center font-cinzel">
          ...
          <p className="text-lg md:text-xl font-light">
            Open for all Christian Churches in the Province of Batangas
          </p>
        </div>
      </div>
    </>
